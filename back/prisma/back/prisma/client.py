...
datasource db {
  provider = "postgresql"
  url      = "postgresql://postgres:+Whales2022@localhost:5432/flasksql"
}
...
class Prisma:
    ...
    searchs: 'actions.SearchsActions'
    ...
    def __init__(
        ...
        *,
        ...
        self.users = actions.UsersActions(self, models.Users)
        self.searchs = actions.SearchsActions(self, models.Searchs)
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.searchs = SearchsBatchActions(self)
